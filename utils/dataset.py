...
def get_dataloaders(train_seqs, test_seqs, train_images_path, test_images_path):
  ...
  # train data
  #train_anns=okutama_read_dataset('/content/drive/MyDrive/Train-Set/Labels/SingleActionLabels/3840x2160', train_seqs)
  train_anns=okutama_read_dataset('/content/drive/MyDrive/Drone-Action/datasets/Train-Set/Labels/SingleActionLabels/3840x2160', 
                                  train_seqs, train_images_path)
  ...
  #test data
  #test_anns=okutama_read_dataset('/content/drive/MyDrive/Test-Set/Labels/SingleActionLabels/3840x2160', test_seqs)
